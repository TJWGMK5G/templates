!(function () {
  ...
  if ("querySelector" in document && "addEventListener" in window) {
      ...
      r = function (e) {
        ...
        e.getAttribute("aria-expanded")
          ...
          : (e.setAttribute("aria-expanded", "true"),
            e.setAttribute("aria-label", generatepressMenu.closeSubMenuLabel));
      },
      s = function (e, t) {
        var n = "";
        if (
          (n = (t = t || this).getAttribute("data-nav")
            ? document.getElementById(t.getAttribute("data-nav"))
            : document.getElementById(t.closest("nav").getAttribute("id")))
        ) {
          var s = !1,
            o =
              (t.closest(".mobile-menu-control-wrapper") && (s = !0),
              n.getElementsByTagName("ul")[0]);
          if (n.classList.contains("toggled"))
            n.classList.remove("toggled"),
              ...
              (s || (l && n.classList.contains("main-navigation"))) &&
            ...
            n.classList.add("toggled"),
              ...
              s
                ? (l.classList.add("toggled"),
                  l.querySelector(".search-item") &&
                    l
                      .querySelector(".search-item")
                      .classList.contains("active") &&
                    l.querySelector(".search-item").click())
                : l &&
                  n.classList.contains("main-navigation") &&
                  l.classList.add("toggled");
            t = o;
    ...
    var i = function (e, t) {
      if (
        ((t = t || this).closest("nav").classList.contains("toggled") ||
          c.classList.contains("slide-opened")) &&
        !a.classList.contains("dropdown-click")
      ) {
        e.preventDefault();
        var n,
          t = t.closest("li");
        if (
          (r(t.querySelector(".dropdown-menu-toggle")),
          (n = t.querySelector(".sub-menu")
            ? t.querySelector(".sub-menu")
            : t.querySelector(".children")),
          generatepressMenu.toggleOpenedSubMenus)
        ) {
          var s = o(t);
          for (f = 0; f < s.length; f++)
            s[f].classList.contains("sfHover") &&
              (s[f].classList.remove("sfHover"),
              s[f].querySelector(".toggled-on").classList.remove("toggled-on"),
              r(s[f].querySelector(".dropdown-menu-toggle")));
        }
    ...
    var d = function () {
      ...
      for (f = 0; f < e.length; f++) {
        ...
        if (
          (t =
            l &&
            !t.closest("nav").classList.contains("mobile-menu-control-wrapper")
              ? l.querySelector(".menu-toggle")
              : t) &&
          null === t.offsetParent
        ) {
          if (e[f].classList.contains("toggled")) {
            var n,
              ...
              r = !1;
            if (
              ((r = e[f].classList.contains("mobile-menu-control-wrapper")
                ? !0
                : r) ||
                ((s = (n = e[f].getElementsByTagName("ul")[0])
                  ? n.getElementsByTagName("li")
                  : []),
                (o = n ? n.getElementsByTagName("ul") : [])),
              ...
              for (var a = 0; a < s.length; a++)
                s[a].classList.remove("sfHover");
              for (var i = 0; i < o.length; i++)
                o[i].classList.remove("toggled-on");
              n && n.removeAttribute("aria-hidden");
            }
            u(e[f]);
          }
          l.querySelector(".search-item") &&
            l.querySelector(".search-item").classList.contains("active") &&
            l.querySelector(".search-item").click();
        }
      }
    };
    if (
      ...
      a.classList.contains("dropdown-hover"))
    )
          ...
          function (e) {
            ...
            this.hostname !== window.location.hostname &&
              ...
              (this.closest("nav").classList.contains("toggled") ||
                ...
                (e.preventDefault(),
                (t = this.closest("li")).classList.toggle("sfHover"),
                (e = t.querySelector(".sub-menu"))) &&
    ...
    if (a.classList.contains("dropdown-hover")) {
        ...
        var g = document.querySelectorAll(".menu-bar-items .menu-bar-item > a"),
          ...
          v = function () {
            if (
              ...
              for (var e = this; -1 === e.className.indexOf("menu-bar-items"); )
      ...
      for (f = 0; f < g.length; f++)
        g[f].addEventListener("focus", v), g[f].addEventListener("blur", v);
    }
    if (
        ...
        p[f].addEventListener("touchend", function (e) {
          if (
            ...
            var e = this.closest("li"),
              t = o(e);
            for (f = 0; f < t.length; f++)
              t[f].classList.contains("sfHover") &&
                t[f].classList.remove("sfHover");
