          ...
          function (e) {
            this.contains(e) ||
              (this.element.className +=
                this.element.className.length > 0 ? " " + e : e);
          },
          this
        );
      },
      ...
      (this.cookiesAccepted = null),
        ...
        (this.setStatus = function (n) {
          var i = this,
            ...
            c = new Date(),
            a = new Date();
          cnArgs.onScroll && e.removeEventListener("scroll", this.handleScroll),
            "accept" === n
              ? ((n = "true"),
                a.setTime(
                  parseInt(c.getTime()) + 1e3 * parseInt(cnArgs.cookieTime)
                ))
              : ((n = "false"),
                a.setTime(
                  parseInt(c.getTime()) +
            ...
            cnArgs.globalCookie && (o = this.getDomain(t.location.hostname)),
            "localhost" === t.location.hostname &&
              (s = t.location.pathname.split("/")[1]);
          var r = "";
          "https:" === t.location.protocol && (r = ";secure"),
            (t.cookie =
              cnArgs.cookieName +
              "=" +
              n +
              ...
              o +
              r),
            (this.cookiesAccepted = "true" === n);
          var d = new CustomEvent("setCookieNotice", {
            detail: { value: n, time: c, expires: a, data: cnArgs },
          });
          if (
            (t.dispatchEvent(d),
            this.setBodyClass([
              "cookies-set",
              "true" === n ? "cookies-accepted" : "cookies-refused",
            ]),
            ...
            "automatic" === cnArgs.revokeCookiesOpt &&
              (this.noticeContainer.addEventListener(
                "animationend",
                function e() {
                  i.noticeContainer.removeEventListener("animationend", e),
                    i.showRevokeNotice();
                }
              ),
              this.noticeContainer.addEventListener(
                "webkitAnimationEnd",
                function e() {
                  i.noticeContainer.removeEventListener(
                    "webkitAnimationEnd",
                    e
                  ),
                    i.showRevokeNotice();
            ...
            cnArgs.redirection &&
              (("true" === n && null === this.cookiesAccepted) ||
                (n !== this.cookiesAccepted && null !== this.cookiesAccepted)))
          ) {
            var l = e.location.protocol + "//",
              h = e.location.host + "/" + e.location.pathname;
            cnArgs.cache
              ? ((l =
                  l +
                  h.replace("//", "/") +
                  ("" === e.location.search ? "?" : e.location.search + "&") +
                  "cn-reloaded=1" +
                  e.location.hash),
                (e.location.href = l))
              : ((l =
        ...
        (this.getDomain = function (e) {
          RegExp(/https?:\/\//).test(e) || (e = "http://" + e);
          var t = new URL(e).hostname.split(".");
          return t
            .slice(0)
            .slice(-(4 === t.length ? 3 : 2))
            .join(".");
        }),
        (this.getStatus = function (e) {
          var n = ("; " + t.cookie).split("; cookie_notice_accepted=");
        ...
        (this.showCookieNotice = function () {
          var e = this,
            n = new CustomEvent("showCookieNotice", {
              detail: { data: cnArgs },
            });
          t.dispatchEvent(n),
            ...
            this.noticeContainer.addEventListener("animationend", function t() {
              e.noticeContainer.removeEventListener("animationend", t),
                e.noticeContainer.classList.remove("cn-animated");
            }),
            this.noticeContainer.addEventListener(
              "webkitAnimationEnd",
              function t() {
                e.noticeContainer.removeEventListener("webkitAnimationEnd", t),
                  e.noticeContainer.classList.remove("cn-animated");
              }
            );
        }),
        (this.hideCookieNotice = function () {
          var e = this,
            n = new CustomEvent("hideCookieNotice", {
              detail: { data: cnArgs },
            });
          t.dispatchEvent(n),
            this.noticeContainer.classList.add("cn-animated"),
            ...
            this.noticeContainer.addEventListener("animationend", function t() {
              e.noticeContainer.removeEventListener("animationend", t),
                e.noticeContainer.classList.remove("cn-animated"),
                e.noticeContainer.classList.add("cookie-notice-hidden");
            }),
            this.noticeContainer.addEventListener(
              "webkitAnimationEnd",
              function t() {
        ...
        (this.showRevokeNotice = function () {
          var e = this,
            n = new CustomEvent("showRevokeNotice", {
              detail: { data: cnArgs },
            });
          t.dispatchEvent(n),
        ...
        (this.hideRevokeNotice = function () {
          var e = this,
            n = new CustomEvent("hideRevokeNotice", {
              detail: { data: cnArgs },
            });
          t.dispatchEvent(n),
            this.noticeContainer.classList.add("cn-animated"),
            ...
            this.noticeContainer.addEventListener("animationend", function t() {
              e.noticeContainer.removeEventListener("animationend", t),
                e.noticeContainer.classList.remove("cn-animated"),
                e.noticeContainer.classList.add("cookie-revoke-hidden");
            }),
            this.noticeContainer.addEventListener(
              "webkitAnimationEnd",
              function t() {
        ...
        (this.setBodyClass = function (e) {
          t.body.classList.remove("cookies-revoke"),
            t.body.classList.remove("cookies-accepted"),
            t.body.classList.remove("cookies-refused"),
            t.body.classList.remove("cookies-set"),
            t.body.classList.remove("cookies-not-set");
          for (var n = 0; n < e.length; n++) t.body.classList.add(e[n]);
        }),
        (this.handleScroll = function () {
          (e.pageYOffset ||
            (t.documentElement || t.body.parentNode || t.body).scrollTop) >
            parseInt(cnArgs.onScrollOffset) && this.setStatus("accept");
        }),
        (this.getClosest = function (e, n) {
          for (
